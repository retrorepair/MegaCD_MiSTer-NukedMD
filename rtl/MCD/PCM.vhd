...
begin
		...
		if RST_N = '0' then
			...
			if EN = '1' then
				if IO_WR = '1' then
					...
					case A(3 downto 0) is
						when x"0" =>			--
							DO_REG <= WRA(0)(18 downto 11);
						when x"1" =>			--
							DO_REG <= WRA(0)(26 downto 19);
						when x"2" =>			--
							DO_REG <= WRA(1)(18 downto 11);
						when x"3" =>			--
							DO_REG <= WRA(1)(26 downto 19);
						when x"4" =>			--
							DO_REG <= WRA(2)(18 downto 11);
						when x"5" =>			--
							DO_REG <= WRA(2)(26 downto 19);
						when x"6" =>			--
							DO_REG <= WRA(3)(18 downto 11);
						when x"7" =>			--
							DO_REG <= WRA(3)(26 downto 19);
						when x"8" =>			--
							DO_REG <= WRA(4)(18 downto 11);
						when x"9" =>			--
							DO_REG <= WRA(4)(26 downto 19);
						when x"A" =>			--
							DO_REG <= WRA(5)(18 downto 11);
						when x"B" =>			--
							DO_REG <= WRA(5)(26 downto 19);
						when x"C" =>			--
							DO_REG <= WRA(6)(18 downto 11);
						when x"D" =>			--
							DO_REG <= WRA(6)(26 downto 19);
						when x"E" =>			--
							DO_REG <= WRA(7)(18 downto 11);
						when x"F" =>			--
							DO_REG <= WRA(7)(26 downto 19);
						when others => null;
					end case;
				elsif RAM_RD = '1' then
					RAM_RD_SEL <= '1'; -- data comes straight from the SDRAM adapter (see pcm_mem.sv)
				end if;
			end if;
		end if;
	end process;
	...
	RAM_WE_A <= RAM_WR;
	RAM_RD_A <= RAM_RD;
	DO <= RAM_DI_A when RAM_RD_SEL = '1' else DO_REG;
